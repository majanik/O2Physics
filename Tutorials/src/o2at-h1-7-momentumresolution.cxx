...
struct momentumresolution {
  ...
  HistogramRegistry registry{
    "registry",
    {
      ...
      {"ptMCHistogram", "ptMCHistogram", {HistType::kTH1F, {{nBinsPt, 0., 10.0}}}},
      {"resoHistogram", "resoHistogram", {HistType::kTH2F, {{nBinsPt, 0., 10.0}, {100, -.5, .5}}}}
    }
  };

  void process(aod::Collision const& collision, soa::Join<aod::Tracks, aod::TracksExtra, aod::TracksDCA, aod::McTrackLabels> const& tracks, aod::McParticles const& mcParticles)
  {
    ...
    for (auto& track : tracks) {
      ...
      //find corresponding MC particles for the tracks:
      auto mcParticle = track.mcParticle_as<aod::McParticles>(); //Resolve MC track - no need to touch index!
	...
	registry.get<TH1>(HIST("ptMCHistogram"))->Fill(mcPart.pt());
      }
    }
  }
};
